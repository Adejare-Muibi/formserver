...
const How = () => {
	return (
		<div className="py-[20px] flex items-center w-full justify-around max-md:justify-center max-md:flex-col">
			<div>
				<Image
					className="w-[] max-md:hidden rounded-[15px]"
					src={'/front.avif'}
					height={60}
					width={400}
				/>
			...
			<div className="flex flex-col gap-[70px] max-md:items-center">
				<div className="max-md:hidden">
					...
					<p className="w-[42vw]">
						Here&apos;s what happens after your form is submitted using
						Javascript forms, HTML forms or{' '}
						<span className="font-bold text-[17px]">Formbutton</span>.
					</p>
				</div>
				<div className="max-md:flex max-md:flex-col max-md:items-center lg:hidden gap-[42px]">
					<div className="flex flex-col items-center">
						<h1 className="font-bold text-[40px]">How it works</h1>
						<p className="w-[75vw] max-md:text-center">
							Here&apos;s what happens after your form is submitted using
							Javascript forms, HTML forms or{' '}
							<span className="font-bold text-[17px]">Formbutton</span>.
						</p>
					...
					<div>
						<Image
							className="w-[] lg:hidden rounded-[15px]"
							src={'/front.avif'}
							height={140}
							width={250}
						/>
					...
					<div className="flex flex-col gap-[45px] max-md:items-center">
						...
						<div className="flex gap-[12px]">
							...
							<div>
								...
								<p className="w-[42vw] max-md:w-[60vw]">
									With our direct integrations, we&apos;ll get your data where
									it needs to be - no Zapier required
								</p>
							</div>
						</div>
					</div>
