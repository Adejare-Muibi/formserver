...
const Create = () => {
  return (
    <div className='mx-[70px]  rounded-[30px] items-center flex flex-col bg-[#0E232D] gap-[45px] my-[30px] max-md:items-center max-md:w-full max-md:mx-0 max-md:rounded-[0] py-[85px] '>
