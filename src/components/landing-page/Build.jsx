	...
	return (
		<div className="build justify-center flex flex-col py-[50px] max-md:py-[0] gap-[30px]">
			<div className="flex justify-center flex-col gap-[60px] items-center">
				<div>
					<h2 className="text-[#0E232D] text-[40px] font-bold max-md:text-[30px] max-md:text-center max-md:w-[70vw]">
					...
					<div className="flex flex-col gap-[15px] max-md:items-center">
						<div className="flex flex-col gap-[15px] max-md:items-center">
							...
							<div className="flex flex-col gap-[6px] max-md:items-center">
								<h1 className="text-[#0E232D] text-[20px] font-semibold">
									Powerful JavaScript forms
								</h1>
								<p className="w-[26vw] max-md:w-[75vw] max-md:text-center">
									Use the Form server CLI and React library. Deploy your
									production forms with CI/CD.
								</p>
							</div>
						</div>
						<div className="flex items-center gap-[7px]">
							<Link className="text-[#c02dc1] font-semibold" href={'/'}>
								Learn more
							</Link>
