  ...
  return (
    <div className="flex flex-col justify-center items-center py-20 gap-12">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="max-md:text-center max-md:w-[90vw]">
      ...
      <div className="flex flex-col relative items-center gap-4">
        ...
        <button className="bg-[#384951] absolute top-3 py-1 text-sm px-4 rounded right-2 text-white text-opacity-40" onClick={handleCopyCode}>{isCopy ? "Copied!" : "Copy"}</button>
        <p className="w-[30vw] text-center text-[18px] max-md:w-[90vw]">But you have to write your own CSS codes for your forms </p>
      </div>
    </div>
  );
};
