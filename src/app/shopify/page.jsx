    ...
    <div className='flex flex-col items-center justify-center py-[50px] gap-[80px] w-full'>
        ...
        <div className='flex justify-center items-center flex-col gap-[30px]'>
            <div className='flex flex-col gap-[30px]'>
                <div>
                    <h1 className='text-[40px] font-bold max-md:w-[70vw]'>Adding a form to Shopify</h1>
                </div> 
                <div className='flex flex-col gap-[18px]'>
                    <h1 className='text-[30px] font-bold text-[#c02dc1] w-[50vw] max-md:w-[80vw]'>In this guide we&apos;ll show you how to add a contact form to your Shopify site using Formspree.</h1>
                    <p className='font-bold w-[50vw] text-[19px] max-md:w-[80vw]'>Many Shopify users also use Formspree for their forms. While Shopify does provide a contact form for your website, it&apos;s limited to their own platform leaving you with no options for integrations or more elaborate configurations.</p>
                </div>  
            </div>
            ...
            <div className='flex flex-col gap-[30px] max-md:max-md:w-[80vw]'>
                ...
                <form action="" className='flex flex-col gap-6 w-[50vw]'>
                    <div className='flex flex-col gap-2 max-md:max-md:w-[80vw]'>
                        ...
                        <input type="text" id='Name' className="border h-[10vh] p-[6px] outline-[#e7bae7]" />
                    </div>
                    <div className='flex flex-col gap-2 max-md:max-md:w-[80vw]'>
                        <label htmlFor="Email" >Email</label>
                        <input type="text" id='Email' className="border h-[10vh] p-[6px]" />
                    </div>
                    <div className='flex flex-col gap-2 max-md:max-md:w-[80vw]'>
                        <label htmlFor="Message">Message</label>
                        <textarea name="" id="Message" cols="2" rows="5" className='border p-[6px] outline-[#e7bae7]'></textarea>
                    </div>
                    <div>
                        <button className="px-7 outline-[#e7bae7] py-3 bg-[#c02dc1] text-white border-none rounded-[5px] font-semibold">Send</button>
                    </div> 
                </form>   
            </div>
        </div>
