		...
		<div className="flex flex-col gap-6 items-center my-[40px] w-[100%]">
			<div className="flex flex-col gap-6">
				<div className="flex flex-col gap-5 max-md:items-center">
					...
					<div className="flex flex-col gap-5 max-md:items-center">
						<h1 className="w-[80vw] max-md:w-[86vw]">
				...
				<div className="flex flex-col gap-5 max-md:items-center">
					<h1 className="text-[29px] font-bold max-md:text-center max-md:w-[80vw]">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					...
					<div className="flex flex-col gap-5 max-md:items-center">
						...
						<ul className="flex flex-col gap-7 ml-[45px] max-md:items-center">
							...
							<li className="w-[75vw]">
								<span className="font-bold">Third-party</span> Social Media
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h1 className="text-[29px] max-md:text-[27px] font-bold max-md:text-center">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h2 className="text-[20px] font-bold max-md:w-[80vw] max-md:text-center">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<div>
						<h2 className="text-[20px] font-bold max-md:text-center max-md:w-[80vw]">
					...
					<div className="flex flex-col gap-6 ml-[45px]">
						<ul>
							<li className="font-bold max-md:w-[80vw]">
								Cookies Policy / Notice Acceptance Cookies
							</li>
						</ul>
						<p>Type: Persistent Cookies</p>
						<p>Administered by: Us</p>
						<p className="max-md:max-md:w-[80vw]">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h2 className="text-[20px] font-bold max-md:max-md:w-[80vw] max-md:text-center">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h2 className="text-[20px] font-bold max-md:w-[50vw] max-md:text-center">
				...
				<div className="flex flex-col gap-5 max-md:items-center">
					<h1 className="text-[23px] font-bold max-md:w-[50vw] max-md:text-center">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h2 className="text-[25px] font-bold max-md:w-[50vw] max-md:text-center">
				...
				<div className="flex flex-col gap-6 max-md:items-center">
					<h2 className="text-[25px] font-bold max-md:items-center max-md:w-[50vw] max-md:text-center">
