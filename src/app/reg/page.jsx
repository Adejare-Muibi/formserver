			...
			<div className="lg:flex flex-col items-center gap-[30px]">
				<div className="flex flex-col items-center gap-[16px] max-md:mb-[15px]">
					...
					<p className=" max-md:w-[85vw] max-sm:text[px] text-[15px] w-[47vw] text-center">
						Use this HTML Registration Form to let people sign up for your
						offering, whether its&apos; a free e-book or an in-person workshop.
					</p>
				...
				<form className="flex max-sm:flex   flex-col shadow-lg  gap-6 border-solid border-2  p-7">
					...
					<div className="flex flex-col gap-[6px]">
						...
						<div className="flex gap-[17px]">
							<input
								className="border-solid border-2 lg:w-[24.5vw] max-md:w-[25vw]  p-3"
								type="text"
								placeholder="City"
							/>
							<input
								className="border-solid border-2 lg:w-[9vw] max-md:w-[18vw]  p-3"
								type="text"
								placeholder="State"
							/>
							<input
