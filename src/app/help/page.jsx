	...
	return (
		<div className="bg-[#e7c7e7] flex flex-col items-center gap-[40px] justify-center w-full pt-[100px] pb-[30px] overflow-hidden">
			<div className="flex flex-col justify-center gap-[30px] items-center">
				<div>
					<h1 className="font-bold text-[35px] max-md:w-[70vw] max-md:text-center">
						WE&apos;RE HERE TO HELP!
					</h1>
				</div>
				...
				<form action="" className="flex flex-col bg-transparent gap-[30px]">
					<div className="flex flex-col gap-[20px]">
						<div className="flex gap-[13px]">
							<input
								className="w-[29.5vw] pl-[10.5px] outline-[#CB6CE7] py-[6px] rounded-[5px] max-md:w-[45vw]"
								type="text"
								name="Full_Name"
								id="Full_Name"
						...
						<div className="flex gap-[13px]">
							<input
								className="w-[29.5vw] pl-[10.5px] outline-[#CB6CE7] py-[6px] rounded-[5px] max-md:w-[45vw]"
								type="text"
								placeholder="Live Form URL (Optional)"
							/>
							<input
								className="w-[29.5vw] pl-[10.5px] outline-[#CB6CE7] py-[6px] rounded-[5px] max-md:w-[45vw]"
								type="text"
								placeholder="Live Form Email Address (Optional)"
							/>
						</div>
					</div>
					<textarea
						className="pl-[10.5px] pt-[10px] outline-[#CB6CE7] border-none rounded-[5px]"
						name=""
						id=""
						cols="30"
						rows="10"
						placeholder="Tell us about your problem in detailed"
					></textarea>
				</form>
				<div className="flex flex-col gap-[20px]">
					<button className="px-7 py-3 bg-[#c02dc1] text-white border-none rounded-[5px] font-semibold">
						Submit Your Inquiry
					</button>
				</div>
			</div>
