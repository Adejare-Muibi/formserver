  ...
  return (
        <div className='lg:flex flex-col items-center gap-4 p-6'>
            <div className='lg:flex flex-col items-center'>
                <h1 className='text-[35px] max-sm:text-center font-bold'>Basic RSVP Form</h1>
                <p className=' max-sm:w-[100vw] max-sm:text[px] p-8 text-[15px] w-[47vw] text-center'>This RSVP Form with HTML includes everything you need to gather information from your guests, whether it's just a dinner with friends, or a huge celebration.</p>
                ...
                <form className='flex max-sm:flex flex-col  shadow-lg  gap-6 border-solid border-2  p-7'>
                    ...
                    <div className='border-solid text-[grey]  border-2 lg:w-[7vw] p-2 items-center flex justify-center'><button>RSVP</button></div>
                </form> 
            </div>
