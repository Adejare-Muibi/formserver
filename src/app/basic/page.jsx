        ...
        <div className='lg:flex flex-col items-center gap-[30px] p-6'>
            <div className='lg:flex flex-col items-center gap-[30px]'>
                <div className="flex flex-col items-center gap-[16px] max-md:pb-[15px]">
                    <h1 className='text-[25px] max-sm:text-center font-bold'>Basic RSVP Form</h1>
                    <p className=' max-md:w-[85vw] max-sm:text[px] text-[15px] w-[47vw] text-center'>This RSVP Form with HTML includes everything you need to gather information from your guests, whether it's just a dinner with friends, or a huge celebration.</p>
                ...
                <form className='flex max-sm:flex flex-col  shadow-lg  gap-7 border-solid border-2  p-7'>
                    ...
                    <div className="flex flex-col gap-[6px]">
                        <label className='lg:text-[15px]  text-[grey]' htmlFor="">Will you  attend?</label>
                    ...
                    <div className="flex flex-col gap-[6px]">
                        <label className='lg:text-[15px]  text-[grey]' htmlFor="">And with how many guests</label>
                        <select className='p-3  border-solid border-2 text-[grey] ' name="timely" id="timely" required="">
                            <option value="0" security="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                    ...
                    <div className='border-solid text-[grey] flex items-center justify-center border-2 max-md:w-[100%] py-[10px] w-[7vw]'><button className=''>RSVP</button></div>
                </form> 
            </div>
