    ...
    <div className='lg:flex flex-col items-center gap-[30px] p-6'>
        <div className='lg:flex flex-col items-center gap-[30px]'>
            <div className="flex flex-col items-center gap-[16px] max-md:mb-[15px]">
              <h1 className='text-[25px] max-sm:text-center font-bold'>Department Contact Form</h1>
              <p className=' max-md:w-[90vw] max-sm:text[px] text-[15px] w-[47vw] text-center'>This HTML Contact Form with a department drop-down will allow customers to send an email the right department without having to know the email address.</p>
            ...
            <form className='flex max-sm:flex   flex-col shadow-lg  gap-6 border-solid border-2  p-7'>
              ...
              <div className="flex flex-col gap-[6px]">
                <label className='lg:text-[15px]  text-[grey]' htmlFor="">Department</label>
              ...
              <div className='border-solid text-[grey] flex items-center justify-center border-2 max-md:w-[100%] py-[10px] w-[12vw]'><button className=''>Send Message</button></div>
            </form> 
        </div>
        <div className='flex flex-col items-center justify-center p-5'>
