		...
		<div className="flex flex-col gap-6 items-center my-[40px] w-[100%] terms">
			<div className="flex flex-col gap-5 max-md:items-center">
				<div className="flex flex-col gap-14 max-md:items-center">
					<h1 className="text-[36px] max-md:text-[32px] font-bold max-md:w-[65vw] max-md:text-center">
						Formserver Terms of Service
					</h1>
					<p>Last updated: May 08, 2024</p>
				</div>
				<div className="flex flex-col gap-5 max-md:items-center">
					<h1 className="w-[80vw] max-md:w-[80vw]">
						Welcome to FormServer.io! These Terms of Service (&quot;Terms&quot;)
						govern your access to and use of FormServer.io&apos;s website,
						products, and services (collectively, the &quot;Services&quot;). By
						accessing or using the Services, you agree to be bound by these
						Terms. Please read them carefully before using the Services.
					</h1>
				</div>
			</div>
			<div className="flex flex-col gap-5 max-md:items-center">
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						FormServer.io provides a platform that simplifies form submission
						for both developers and no-code users. Our Services include, but are
						not limited to, form creation, customization, hosting, submission
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						...
						required to create a user account. You agree to provide accurate and
						complete information when creating your account, and to keep your
						password secure. You are responsible for all activities that occur
						under your account.
					</p>
				</div>
				<div className="gap-4 flex flex-col">
					<div className="gap-1 flex flex-col">
						...
						<p className="max-md:w-[80vw]">
							When using FormServer.io, you agree to:
						</p>
					</div>
					<ul className="my ml-[45px] flex flex-col gap-1 max-md:ml-[0px]">
						<li className="max-md:w-[80vw]">
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						FormServer.io respects your privacy and is committed to protecting
						your personal data. Our Privacy Policy explains how we collect, use,
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						...
						the property of FormServer.io or its licensors and are protected by
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						Certain features of the Services may require payment of fees. By
						using these paid features, you agree to pay all applicable fees and
						charges. All payments are non-refundable unless otherwise stated.
					</p>
				</div>
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						...
						express or implied. FormServer.io makes no representations or
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						In no event shall FormServer.io be liable for any direct, indirect,
						incidental, special, or consequential damages arising out of or in
						any way connected with your use of the Services, whether based on
				...
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						You agree to indemnify and hold harmless FormServer.io and its
						officers, directors, employees, and agents from and against any and
						all claims, liabilities, damages, losses, or expenses arising out of
						or in any way related to your use of the Services or violation of
						these Terms.
					</p>
				</div>
				<div className="gap-1 flex flex-col">
					...
					<p className="w-[80vw]">
						FormServer.io reserves the right to modify or update these Terms at
						any time without prior notice. By continuing to use the Services
						after such changes are made, you agree to be bound by the revised
						Terms.
					</p>
				</div>
				<div className="gap-1 flex flex-col">
			...
			<div className="pt-5">
				<p className="w-[80vw]">
					By using FormServer.io, you acknowledge that you have read,
