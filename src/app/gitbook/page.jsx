				...
				<div className="flex flex-col gap-[30px]">
					...
					<div className="flex flex-col gap-[18px]">
						<h1 className="text-[30px] font-bold text-[#c02dc1] w-[50vw] max-md:w-[80vw]">
							In this guide we&paos;ll show you how to add a contact form to
							your GitBook website using Formserver.
						</h1>
						<p className="font-bold w-[50vw] text-[19px] max-md:w-[80vw]">
							Formserver is a form API that&paos;s an ideal companion for your
							GitBook documentation site, letting your users easily contact you.
						</p>
					</div>
				</div>
